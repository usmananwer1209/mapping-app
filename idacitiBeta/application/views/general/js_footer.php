...
<script src="<?php echo js_url('center')."?v=".$this->config->item('files_version'); ?>"></script>
	...
	<script>
		...
		$("#range_03").ionRangeSlider({
			...
			from: <?php if(isset($min_value)) echo $min_value; else echo 0; ?>,
			to: <?php if(isset($max_value)) echo $max_value; else echo 0; ?>,
			grid: false,
			onFinish: showResult,
		});
...
<?php } ?>
    ...
    <script src="<?php echo js_url('term')."?v=".$this->config->item('files_version'); ?>"></script>

	<script src="https://code.highcharts.com/highcharts.js"></script>
	<script src="https://code.highcharts.com/modules/exporting.js"></script>	

<?php
if(isset($term_rules_check) && $term_rules_check=='view_term_rule')
{	
?>

	<script type="text/javascript">

	    var annual_name = [<?php echo $annual_name; ?>];
	    var annual_amount = [<?php echo $annual_amount; ?>];
	    var quarter_name = [<?php echo $quarter_name; ?>];
	    var quarter_amount = [<?php echo $quarter_amount; ?>];
...
{	
?>
    <script src="<?php echo js_url('term_highcharts')."?v=".$this->config->item('files_version'); ?>"></script>
<?php
}
else
{
?>
    <script src="<?php echo js_url('term_piechart')."?v=".$this->config->item('files_version'); ?>"></script>    
<?php
}
?>
