...
var start = parseInt($('#page_content_count').val());
var record_count = parseInt($('#page_content_count').val());
var limit = parseInt($('#page_content_count').val());
var total_result_count = parseInt($('#total_result_count').val());
